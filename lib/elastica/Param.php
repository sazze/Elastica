...
class Param
{
	...
	public function toArray() {
		...
		$classNameParts = str_replace('_', '', explode('\\', get_class($this)));
		$partClassName = Util::toSnakeCase(array_pop($classNameParts));
	 ...
	 * @throws \elastica\exception\Invalid If requested key is not set
	 */
	public function getParam($key) {
		if (!isset($this->_params[$key])) {
			throw new exception\Invalid('Param ' . $key . ' does not exist');
		}

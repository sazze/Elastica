...
class Request {
	 ...
	 *
	 * @return elastica\transport\Abstract Transport object
	 * @throws \elastica\exception\Invalid If invalid transport type
	 */
	public function getTransport() {
		$className = 'elastica\\transport\\' . $this->_client->getConfig('transport');
		if (!class_exists($className)) {
			throw new exception\Invalid('Invalid transport');
		}

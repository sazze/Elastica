...
class Range extends Abstract_
{
	...
	public function toArray() {
		...
		if ($fieldTypesSet === 0) {
			throw new \elastica\exception\Invalid('Neither field, key_field nor key_script is set.');
		} else if ($fieldTypesSet > 1) {
			throw new \elastica\exception\Invalid('Either field, key_field and key_value or key_script and value_script should be set.');
		}
